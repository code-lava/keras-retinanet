...
def parse_args(args):
    ...
    parser.add_argument('--image-max-side', help='Rescale the image if the largest side is larger than max_side.', type=int, default=1980)
...
def run(generator, args, anchor_params):
    ...
    for i in range(generator.size()):
        ...
        if args.annotations:
            ...
            dummy = max_indices[positive_indices]
            dummy2 = annotations['bboxes'][max_indices[positive_indices], :]
